...
class GF_Field_CreditCard extends GF_Field {
	...
	public function validate( $value, $form ) {
		//if(!empty($_SESSION['isCreditCardApproved'])) {
			//if ($_SESSION['isCreditCardApproved'] == true) {
				////Credit card is already approved
				//echo " credit card approved true = validate at " . __FILE__ . ' Line ' . __LINE__ . '<BR>';
			//} else {
			////	echo "credit card approved false = validate at " . __FILE__ . ' Line ' . __LINE__ . '<BR>';
